...
tags: [money-model, cash-flow, cac-payback, offers, continuity, alex-hormozi]
source:
  type: "book"
...
## Source reference
Alex Hormozi, *$100M Money Models* (2025). Extraction notes in `_Inbox/$100M series — Alex Hormozi.md` (processed; source condensed and archived per WIKI workflow).
