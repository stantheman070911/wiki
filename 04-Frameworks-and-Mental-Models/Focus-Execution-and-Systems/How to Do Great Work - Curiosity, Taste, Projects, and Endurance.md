...
## Context
There is no guaranteed recipe for exceptional work, but productive patterns recur across fields. The aim is to increase exposure to good problems and remain engaged long enough for compounding skill and insight to matter.
...
Cycle through **explore → choose a promising question → build a small project → compare it with your taste → learn the missing skill → revise or branch**. Keep the cycle close enough to reality that each iteration produces an artifact, result, or sharper question.
...
- Review annually whether the field still offers questions you care enough to pursue.
