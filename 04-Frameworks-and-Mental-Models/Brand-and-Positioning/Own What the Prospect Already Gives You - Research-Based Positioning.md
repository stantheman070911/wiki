...
## Context
Ries and Trout's Long Island Trust and United Jersey bank case studies show a different move than "find the hole" against a leader: instead of scanning the market for an open gap, you scan the *prospect's existing mental map of you* and take the one attribute they already hand you for free — then commit the whole company to it, not just the advertising.

## Key insights
- **Conventional wisdom says fix your weaknesses; positioning says don't.** Long Island Trust ranked *last* against big-city banks (Citibank, Chase) on every traditional banking attribute — branches, service range, service quality, capital. Running ads about "great service" would have fought a losing, already-decided battle in the prospect's mind.
...
1. **Map the mind, not the product.** Select the attributes prospects actually judge the category on, and have them rank every competitor (including you) on each, typically 1–10.
2. **Look for the attribute where you already win**, even if it isn't the "important" traditional one — that is the position the prospect is actually willing to concede to you.
