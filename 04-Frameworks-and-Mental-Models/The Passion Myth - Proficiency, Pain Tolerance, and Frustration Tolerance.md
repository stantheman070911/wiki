...
category: "Frameworks"
tags: [passion, proficiency, frustration-tolerance, consistency, reinforcement, alex-hormozi]
source:
  type: "video"
...
## Context
Hormozi addresses a young man who quit sales to "find his passion." Having gone full-cycle on his own passion (fitness → a $46.2M exit → a members-free gym he loves but doesn't monetize), he argues passion is a bad judgment filter and reframes what actually sustains a career.

## Key insights
- **Passion is true only in the vague.** Played out specifically, doing "only your passion" means only the narrow slice you love — but getting to do that slice requires vast amounts of work that isn't it. "Business is a funnelling mechanism of the hardest and worst problems related to the thing you supposedly love."
- **Interests start you, proficiency continues you, pain tolerance finishes you.** People often use "passion" to disguise an inability to tolerate hardness. Chris Rock: "Follow your dreams — if they're hiring."
- **Be passionate about excellence, not the task.** A friend built a high-end cookie company he wasn't passionate about because "I'm passionate about being excellent." You grow to love things you get good at; let your *values* show through the work rather than requiring the work itself to be the passion.
...
## Source reference
Alex Hormozi, *If You're Ambitious but Inconsistent, Please Watch This* (playlist: *How to Make Your First $100,000*). Extraction notes in `06-Source-Library/Podcasts/2026-07-08_Playlist_AlexHormozi_HowToMakeYourFirst100000.md`.
