...
## Context
Named after Vilfredo Pareto's 1906 observation that 20% of Italy's landowners held 80% of the land (the same pattern he saw in his own garden's peapods), the power law shows up in earthquakes, city sizes, and monopoly profits. Thiel argues it's the single most important thing even professional VCs routinely fail to internalize, with direct consequences for how any individual should think about a career, not just a fund.

## Key insights
- **The normal-distribution error.** Investors instinctively expect venture returns to look like a bell curve — bad companies fail, mediocre ones flatline, good ones return 2–4x — and build a diversified portfolio on that assumption, hoping winners offset losers. That pattern doesn't hold: a small number of companies radically outperform everything else, so diversifying away from concentrated bets means missing the outliers that make a fund work at all.
- **Founders Fund's own numbers prove it.** In their 2005 fund, Facebook alone returned more than every other investment combined; Palantir, the second-best, returned more than the sum of everything else besides Facebook. This lopsided pattern recurs across their other funds — not an anomaly.
...
## Notable examples
- Pareto's 80/20 landholding and peapod observations (1906) as the namesake origin of the "power law."
