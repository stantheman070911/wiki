...
Browse by `person/` and `source/` tags in the tag pane, or search within this folder. Sources larger than about 1 MB deserve a look at whether splitting them would help navigation.
...
```dataview
TABLE WITHOUT ID file.link AS "Source", author AS "Author", archived AS "Archived"
