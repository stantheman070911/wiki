...
- New entry → duplicate `00-Templates/Entry-Template.md` into the relevant domain folder
- Unsure where something goes → drop it in `_Inbox/` first
- Looking for a topic → use Quick Switcher (`Cmd+O`) or global search (`Cmd+Shift+F`)
...
---
*Full conventions and structure: [[README|README]]*
