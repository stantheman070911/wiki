...
Outward-facing essays synthesized from multiple entries. Belongs here: finished articles and publishable drafts that combine several entries into one narrative. Does not belong here: raw source notes, single-idea entries, or internal-only playbooks.
